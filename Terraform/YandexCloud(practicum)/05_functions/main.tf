...
# В соответствии с этой конфигурацией при запуске ВМ установится пакет nginx и произойдёт замена стартовой страницы nginx. C помощью конструкций ${ydb_connect_string} и ${bucket_domain_name} можно вставить значения соответствующих переменных в шаблон.
  metadata = {
